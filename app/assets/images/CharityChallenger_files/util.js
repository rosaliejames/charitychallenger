...
<div id="container">
  <h2>No route matches [GET] &quot;/assets/js/util.js&quot;</h2>

  
<p><code>Rails.root: /Users/gracemariezeng/Documents/ixperience/projects/charitychallenger</code></p>
...
<div id="traces">
    ...
    <div id="Framework-Trace" style="display: none;">
      <pre><code><a class="trace-frames" data-frame-id="0" href="#">actionpack (4.2.1) lib/action_dispatch/middleware/debug_exceptions.rb:21:in `call&#39;</a><br><a class="trace-frames" data-frame-id="1" href="#">web-console (2.1.3) lib/web_console/middleware.rb:37:in `call&#39;</a><br><a class="trace-frames" data-frame-id="2" href="#">actionpack (4.2.1) lib/action_dispatch/middleware/show_exceptions.rb:30:in `call&#39;</a><br><a class="trace-frames" data-frame-id="3" href="#">railties (4.2.1) lib/rails/rack/logger.rb:38:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="4" href="#">railties (4.2.1) lib/rails/rack/logger.rb:20:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="5" href="#">activesupport (4.2.1) lib/active_support/tagged_logging.rb:68:in `block in tagged&#39;</a><br><a class="trace-frames" data-frame-id="6" href="#">activesupport (4.2.1) lib/active_support/tagged_logging.rb:26:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="7" href="#">activesupport (4.2.1) lib/active_support/tagged_logging.rb:68:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="8" href="#">railties (4.2.1) lib/rails/rack/logger.rb:20:in `call&#39;</a><br><a class="trace-frames" data-frame-id="9" href="#">quiet_assets (1.1.0) lib/quiet_assets.rb:27:in `call_with_quiet_assets&#39;</a><br><a class="trace-frames" data-frame-id="10" href="#">actionpack (4.2.1) lib/action_dispatch/middleware/request_id.rb:21:in `call&#39;</a><br><a class="trace-frames" data-frame-id="11" href="#">rack (1.6.4) lib/rack/methodoverride.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="12" href="#">rack (1.6.4) lib/rack/runtime.rb:18:in `call&#39;</a><br><a class="trace-frames" data-frame-id="13" href="#">activesupport (4.2.1) lib/active_support/cache/strategy/local_cache_middleware.rb:28:in `call&#39;</a><br><a class="trace-frames" data-frame-id="14" href="#">rack (1.6.4) lib/rack/lock.rb:17:in `call&#39;</a><br><a class="trace-frames" data-frame-id="15" href="#">actionpack (4.2.1) lib/action_dispatch/middleware/static.rb:113:in `call&#39;</a><br><a class="trace-frames" data-frame-id="16" href="#">rack (1.6.4) lib/rack/sendfile.rb:113:in `call&#39;</a><br><a class="trace-frames" data-frame-id="17" href="#">railties (4.2.1) lib/rails/engine.rb:518:in `call&#39;</a><br><a class="trace-frames" data-frame-id="18" href="#">railties (4.2.1) lib/rails/application.rb:164:in `call&#39;</a><br><a class="trace-frames" data-frame-id="19" href="#">rack (1.6.4) lib/rack/content_length.rb:15:in `call&#39;</a><br><a class="trace-frames" data-frame-id="20" href="#">puma (2.11.3) lib/puma/server.rb:507:in `handle_request&#39;</a><br><a class="trace-frames" data-frame-id="21" href="#">puma (2.11.3) lib/puma/server.rb:375:in `process_client&#39;</a><br><a class="trace-frames" data-frame-id="22" href="#">puma (2.11.3) lib/puma/server.rb:262:in `block in run&#39;</a><br><a class="trace-frames" data-frame-id="23" href="#">puma (2.11.3) lib/puma/thread_pool.rb:104:in `call&#39;</a><br><a class="trace-frames" data-frame-id="24" href="#">puma (2.11.3) lib/puma/thread_pool.rb:104:in `block in spawn_thread&#39;</a><br></code></pre>
    </div>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#cancel'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#create'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#new'>
    registrations#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#edit'>
    registrations#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#update'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='registrations#destroy'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='challenges'>
      challenges<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/challenges(.:format)' data-regexp='^\/challenges(?:\.([^\/.?]+))?$'>
    /challenges(.:format)
  </td>
  <td data-route-reqs='challenges#index'>
    challenges#index
  </td>
</tr>
<tr class='route_row' data-helper='path'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='challenges_new'>
      challenges_new<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/challenges/new(.:format)' data-regexp='^\/challenges\/new(?:\.([^\/.?]+))?$'>
    /challenges/new(.:format)
  </td>
  <td data-route-reqs='challenges#new'>
    challenges#new
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-reqs='challenges#create'>
    challenges#create
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/challenges/:id(.:format)' data-regexp='^\/challenges\/([^\/.?]+)(?:\.([^\/.?]+))?$'>
    /challenges/:id(.:format)
  </td>
  <td data-route-reqs='challenges#show'>
    challenges#show
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='complete'>
      complete<span class='helper'>_path</span>
  </td>
  <td data-route-verb='PUT'>
    PUT
  </td>
  <td data-route-path='/challenges/:id/complete(.:format)' data-regexp='^\/challenges\/([^\/.?]+)\/complete(?:\.([^\/.?]+))?$'>
    /challenges/:id/complete(.:format)
  </td>
  <td data-route-reqs='challenges#complete'>
    challenges#complete
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='destroy'>
      destroy<span class='helper'>_path</span>
  </td>
  <td data-route-verb='DELETE'>
    DELETE
  </td>
  <td data-route-path='/challenges/:id/destroy(.:format)' data-regexp='^\/challenges\/([^\/.?]+)\/destroy(?:\.([^\/.?]+))?$'>
    /challenges/:id/destroy(.:format)
  </td>
  <td data-route-reqs='challenges#destroy'>
    challenges#destroy
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='challenge_edit'>
      challenge_edit<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/challenges/:id/edit(.:format)' data-regexp='^\/challenges\/([^\/.?]+)\/edit(?:\.([^\/.?]+))?$'>
    /challenges/:id/edit(.:format)
  </td>
  <td data-route-reqs='challenges#edit'>
    challenges#edit
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='challenge'>
      challenge<span class='helper'>_path</span>
  </td>
  <td data-route-verb='PATCH'>
    PATCH
  </td>
  ...
  <td data-route-reqs='challenges#update'>
    challenges#update
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='confirm_challenge'>
      confirm_challenge<span class='helper'>_path</span>
  </td>
  <td data-route-verb='GET'>
    GET
  </td>
  <td data-route-path='/challenges/:id/confirm(.:format)' data-regexp='^\/challenges\/([^\/.?]+)\/confirm(?:\.([^\/.?]+))?$'>
    /challenges/:id/confirm(.:format)
  </td>
  <td data-route-reqs='challenges#confirm'>
    challenges#confirm
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='buy_challenge'>
      buy_challenge<span class='helper'>_path</span>
  </td>
  <td data-route-verb='POST'>
    POST
  </td>
  ...
  <td data-route-reqs='challenges#buy'>
    challenges#buy
  </td>
</tr>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;YfyFGeC/qchYA/lu/bVQQapc/+9uyRsKsTRHdjGUoag=&quot;
session_id: &quot;8d68c3a7c72149ef653c4b97a879641e&quot;
warden.user.user.key: [[6], &quot;$2a$10$sMzxjajeplnaIgGVlohlXu&quot;]</pre></div>
</div>
...
<div id="console"
  data-remote-path='console/repl_sessions/4c9f14c65a11f3a960e6f4fe6c4aacb7'
  data-initial-prompt='>> '>
</div>
